...
const DoctorTab = () => {
  // roles list
  const rolesData = ["Rounding Doctor", "ARNP", "Receiving Doctor"];
  ...
  const fetchDoctors = async () => {
    try {
      const response = await GetDoctorAPI(token);
      ...
      <Box sx={{ width: "100%", mt: 5 }}>
        ...
        <Formik
          ...
          onSubmit={async (values, { setStatus, resetForm, setFieldValue }) => {
            ...
            try {
              const response = await AddDoctorAPI(values, token);
            ...
            <form noValidate onSubmit={handleSubmit}>
              <Grid container spacing={3}>
                ...
                <Grid item md={12} xs={12}>
                  <Stack spacing={1}>
                    <InputLabel htmlFor="name-login">Doctor</InputLabel>
                    <OutlinedInput
                      id="name-login"
                      type="text"
                      value={values.name}
                        ...
                        <TableRow hover key={row.id} sx={{ cursor: "pointer" }}>
                          ...
                          <TableCell align="right" sx={{ px: 3 }}>
                            <Button
                              ...
                              sx={{ ml: 2 }}
                              onClick={() =>
                                handleEditClick(row, { action: "edit" })
                              }
                            >
                              Edit
                            </Button>
                            <Button
                              ...
                              sx={{ ml: 2 }}
                              onClick={() =>
                                handleDeleteClick(row, { action: "delete" })
                              }
                            >
                              Delete
                            </Button>
